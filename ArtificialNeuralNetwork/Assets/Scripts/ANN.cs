...
public class ANN
{
    ...
    /// </returns>
    public List<double> Calculate(List<double> _inputValues, List<double> _desiredValues)
    {
        ...
        for (int i = 0; i < numHidden + 1; i++)
        {
            ...
            if (i > 0)
            {
                //Output from the previous layer to put into inputs for the current layer
        ...
        UpdateWeights(outputs, _desiredValues);
    ...
    /// <summary>
    /// It's a type of activation function called Step function or binar step
    /// </summary>
    ...
    /// <summary>
    /// It's a type of activation function called sigmoid function or logistic soft step
    /// </summary>
    /// <param name="val"></param>
    /// <returns>
    /// Gets only 0 to 1
    ...
    {
        double k = (double)System.Math.Exp(val);
